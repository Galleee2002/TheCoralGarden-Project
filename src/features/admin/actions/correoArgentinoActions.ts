...
import {
  ...
  type CorreoArgentinoSettingsInput,
...
async function persistCorreoArgentinoSettings(
  parsedInput: CorreoArgentinoSettingsInput
) {
...
export const upsertCorreoArgentinoSettings = action
  ...
  .action(async ({ parsedInput }) => {
    await persistCorreoArgentinoSettings(parsedInput);
